...
<body>
    ...
    if(isset($_POST['cap_nhat_mat_hang'])) {
        ...
        $stmt = $ket_noi->prepare($cap_nhat_sql);
        $stmt->bind_param("ssdi", $ten_mat_hang, $loai_mat_hang, $gia_mat_hang, $so_luong, $id);
        $stmt->execute();
        $stmt->close();
    ...
    if (isset($_POST['them_mat_hang'])) {
        ...
        $stmt->bind_param("ssdis", $ten_mat_hang, $loai_mat_hang, $gia_mat_hang, $so_luong, $hinh_anh);
        $stmt->execute();
        $stmt->close();
    }
    ?>
